...
\end{tabular} 
\par
Comparison of accuracy on the validation dataset for random choice, Deep Structured Semantic Model (DSSM), CGAN from the paper we attempted to reproduce and our CGAN.
\end{center}
